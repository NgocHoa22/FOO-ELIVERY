...
$sql = "SELECT id, total_amount, status, created_at, shipping_address FROM orders WHERE id = ? AND user_id = ?";
$stmt = mysqli_prepare($connect, $sql);
...
<head>
    ...
    <title>Chi Tiết Đơn Hàng - BTEC Sweet Shop</title>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="order-detail">
                        ...
                        <div class="map-section">
                            <img src="https://cdn-icons-png.flaticon.com/512/2983/2983788.png" alt="Người đi trên bản đồ">
                            <div>
